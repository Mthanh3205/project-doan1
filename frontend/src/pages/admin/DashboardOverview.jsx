// File: pages/admin/DashboardOverview.jsx
...
const StatCard = ({ icon, title, value, bgColor }) => (
  ...
  >
    ...
    <div>
      ...
      <p className="text-2xl font-bold text-white h-8">{value}</p>
    </div>
  </div>
);

// Component Trang Tổng Quan (Đã sửa)
    ...
    <div>
      ...
      <div className="mb-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <StatCard
          ...
          value={userValue} {/* <-- Sử dụng biến động */}
        ...
        <StatCard
          ...
          value={topicValue} {/* <-- Sử dụng biến động */}
        ...
        <StatCard
          ...
          value={wordValue} {/* <-- Sử dụng biến động */}
        ...
        <StatCard
          ...
          value={feedbackValue} {/* <-- Sử dụng biến động */}
